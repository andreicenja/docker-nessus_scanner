...
This is a fork of [Steve McGrath's Unofficial Nessus Scanner](https://github.com/SteveMcGrath/docker-nessus_scanner) - but using Alma8 and having Nessus 10.6.3 scanner installed from the get-go.
